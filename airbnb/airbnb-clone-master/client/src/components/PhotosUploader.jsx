...
import { userInstance } from "../apiCalls/axiosInstance.js";

export default function PhotosUploader({addedPhotos,onChange}) {
  const [photoLink,setPhotoLink] = useState('');
  async function addPhotoByLink(ev) {
    ev.preventDefault();
    const {data:filename} = await userInstance.post('/api/upload-by-link', {link: photoLink});
    onChange(prev => {
